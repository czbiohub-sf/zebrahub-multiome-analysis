...
# output_path: path to save the output (peaks, and CCANs)
# data_id: ID for the dataset, i.e. TDR118
# peaktype: type of the peak profile. i.e. CRG_arc: Cellranger-arc peaks
# (i.e. peaks_celltype, peaks_bulk, peaks_joint)
compute_CCANS_cicero <- function(seurat_object=object, 
                                    assay = "ATAC", 
