...
# %% [markdown]
# # Chromatin Velocity Analysis - Interactive Notebook
# 
# This notebook provides an interactive environment to test chromatin velocity with both synthetic and real data.
# 
# **Available datasets:**
# - **Synthetic data** (for testing): `synthetic_peaks_by_pseudobulks.h5ad` and `synthetic_coaccessibility.csv`
# - **Real zebrahub data**: `/hpc/projects/data.science/yangjoon.kim/zebrahub_multiome/data/annotated_data/objects_v2/peaks_by_pb_annotated_master.h5ad`
# - **Real co-accessibility**: `/hpc/projects/data.science/yangjoon.kim/zebrahub_multiome/data/processed_data/13_peak_umap_analysis/cicero_integrated_ATAC_v2/02_integrated_ATAC_v2_cicero_connections_peaks_integrated_peaks.csv`
# 
# **Analysis workflow:**
...
import sys
sys.path.append('..')  # Go up to scripts directory

from chromatin_velocity import ChromatinVelocity
# Note: Other modules optional - only ChromatinVelocity is essential
...
# %%
# Data paths - Choose between synthetic (for testing) or real data
USE_SYNTHETIC_DATA = True  # Set to False for real zebrahub data

if USE_SYNTHETIC_DATA:
    print("Using synthetic test data...")
    peaks_pb_path = "./synthetic_peaks_by_pseudobulks.h5ad"
    coaccess_path = "./synthetic_coaccessibility.csv"
else:
    print("Using real zebrahub-multiome data...")
