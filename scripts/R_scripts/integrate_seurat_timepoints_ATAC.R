...
#     new_seurat_obj$dataset <- data_id
#     return(new_seurat_obj)
# }

# # recompute the count matrices for each dataset, save as "peaks_integrated" ChromatinAssay
# TDR118_ATAC <- recompute_count_matrices(TDR118_ATAC, combined.peaks = combined.peaks, data_id="TDR118")
# TDR119_ATAC <- recompute_count_matrices(TDR119_ATAC, combined.peaks = combined.peaks, data_id="TDR119")
# TDR124_ATAC <- recompute_count_matrices(TDR124_ATAC, combined.peaks = combined.peaks, data_id="TDR124")
# TDR125_ATAC <- recompute_count_matrices(TDR125_ATAC, combined.peaks = combined.peaks, data_id="TDR125")
# TDR126_ATAC <- recompute_count_matrices(TDR126_ATAC, combined.peaks = combined.peaks, data_id="TDR126")
# TDR127_ATAC <- recompute_count_matrices(TDR127_ATAC, combined.peaks = combined.peaks, data_id="TDR127")
# TDR128_ATAC <- recompute_count_matrices(TDR128_ATAC, combined.peaks = combined.peaks, data_id="TDR128")
...
# Loading the combined object (if we are resuming from here)
