...
# # resort the merged fragments (ChatGPT suggestion)
# sort -k1,1V -k2,2n merged_fragments.tsv > merged_fragments_sorted.tsv

# block gzip compress the merged file
bgzip -@ 4 merged_fragments_sorted.tsv # -@ 4 uses 4 threads

# index the bgzipped file
tabix -p bed merged_fragments_sorted.tsv.gz
