...
#SBATCH --job-name=de_novo_motifs      # Job name
...
# module load R/4.3
conda activate celloracle_shared

# Navigate to the directory containing the python scripts
cd /hpc/projects/data.science/yangjoon.kim/zebrahub_multiome/zebrahub-multiome-analysis/scripts/gimmemotifs/

# Run the Python script with command-line arguments
python compute_de_novo_motifs_scATAC_zebrafish.py
