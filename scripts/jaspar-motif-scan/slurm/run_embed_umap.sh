#!/bin/bash
#SBATCH --job-name=motif_embed_umap
#SBATCH --ntasks=1
...
#SBATCH --gres=gpu:1
#SBATCH --output=logs/motif_embed_umap_%j.out
#SBATCH --error=logs/motif_embed_umap_%j.err

echo "========================================"
echo "Cross-species motif UMAP embedding"
...
SCRIPT="${REPO}/notebooks/EDA_peak_umap_cross_species/05_embed_motif_umap.py"
